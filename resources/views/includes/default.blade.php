...
<body>
    <!--- Include header Include/header.blade.php file -->
    ...
    @section('Categories-Start')
        <!-- Categories Start -->
        <section class="Categories-Start">
            <div class="container-fluid pt-5">
                <div class="row px-xl-5 pb-3">
    ...
    @section('Vendor-Start')
        <!-- Vendor Start -->
        <section class="Vendor-Start">
